...
create table bank_account (id bigint not null, created timestamp, modified timestamp, name varchar(255), number varchar(255), primary key (id));

create table bill (id bigint not null, created timestamp, currency varchar(255), description varchar(255), modified timestamp, sum decimal(19,2), title varchar(255), buyer_id bigint, primary key (id));
...
create table bill_payment (id bigint not null, created timestamp, modified timestamp, sum decimal(19,2), persons_id bigint, primary key (id));

create table debt (id bigint not null, created timestamp, currency varchar(255), modified timestamp, sum decimal(19,2), payer_id bigint, receiver_id bigint, primary key (id));

create table event (id bigint not null, closed timestamp, created timestamp, modified timestamp, title varchar(255), primary key (id));
...
create table person (id bigint not null, created timestamp, email varchar(255), first_name varchar(255), last_name varchar(255), modified timestamp, password varchar(255), bank_account_id bigint, primary key (id));
